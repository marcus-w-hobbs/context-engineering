 ...
 * 
 * Opens an interactive overlay in the browser. Click to select elements,
 * Cmd/Ctrl+Click for multi-select, Enter to confirm.
 * 
 * Usage:
 *   ./pick.js "Click the submit button"
 *   ./pick.js "Select the element with hot pink"
 * 
